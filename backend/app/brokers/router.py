...
Routing Modes:
1. "asset_class" (default) - Route to best broker per asset (stocks→Alpaca, crypto→Binance)
...
class BrokerRouter:
    ...
    ASSET_BROKER_MAP = {
        ...
        "crypto": "binance",
        "cryptospot": "binance",
        "options": "alpaca",  # Alpaca supports options
        "futures": "ibkr",
        "forex": "ibkr",
        "solana": "solana",
        "defi": "solana",
    ...
    # Broker capabilities
    BROKER_CAPABILITIES = {
        "alpaca": ["stocks", "equities", "options", "crypto"],
        "binance": ["crypto", "cryptospot", "futures"],
        "ibkr": ["stocks", "equities", "options", "futures", "forex"],
        "solana": ["solana", "defi"],
    }
